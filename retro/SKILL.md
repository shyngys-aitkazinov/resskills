...
version: 0.1.0
description: |
  Weekly research retrospective. Reviews recent experiments, git history,
  and findings. Synthesizes progress, identifies patterns, plans next steps.
  Use when asked to "retro", "weekly review", "what happened this week?",
  or "summarize progress".
allowed-tools:
  - Bash
  - Read
  - Write
