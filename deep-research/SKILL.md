...
version: 0.1.0
description: |
  Landscape search before building. Finds existing tools, libraries, repos,
  and prior work that solve parts of the problem. Evaluates quality and
  recommends what to use vs. what to build.
  Use when asked to "research options", "find libraries", "what exists",
  or before starting a new implementation.
allowed-tools:
  - Bash
  - Read
  - Write
