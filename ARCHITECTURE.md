...
| `{{ LEARNINGS_EPILOGUE }}` | `blocks/learnings-epilogue.md` | End-of-session reflection: did commands fail? wrong approach? project quirks? Logs to `~/.resskills/projects/{slug}/learnings.jsonl` with type (technique/pitfall/insight/convention) | All 21 skills |
