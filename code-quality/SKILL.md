...
version: 0.1.0
description: |
  Python code quality enforcement. Runs linters, formatters, type checkers.
  Checks research-specific patterns. Fixes issues automatically where possible.
  Use when asked to "check code quality", "lint", "clean up code", or "enforce standards".
allowed-tools:
  - Bash
  - Read
  - Edit
