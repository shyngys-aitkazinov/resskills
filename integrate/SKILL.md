...
version: 0.1.0
description: |
  Integration strategy for 3rd party code. Assesses quality, chooses an
  integration approach (depend, wrap, fork, extract, or work-within), and
  plans the implementation. Use when asked to "integrate", "incorporate",
  "add this library", or "use this repo".
allowed-tools:
  - Bash
  - Read
  - Write
