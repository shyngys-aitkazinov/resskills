...
version: 0.1.0
description: |
  Statistical analysis of experiment results. Reads results.tsv, computes
  significance tests, confidence intervals, effect sizes. Generates publication-
  quality matplotlib plots. Use when asked to "analyze results", "make plots",
  "are these results significant?", or "summarize experiments".
allowed-tools:
  - Bash
  - Read
  - Write
