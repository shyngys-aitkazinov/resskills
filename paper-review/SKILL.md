...
version: 0.1.0
description: |
  Simulate a conference reviewer. Provides structured review with scores,
  strengths, weaknesses, and decision. Use when asked to "review the paper",
  "what would reviewers say?", "simulate review", or "pre-submission check".
allowed-tools:
  - Bash
  - Read
  - Grep
