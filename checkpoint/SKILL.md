...
version: 0.1.0
description: |
  Save or resume research state. Snapshots the current hypothesis, results,
  open questions, and git state to a timestamped JSON file. On resume, reads
  the latest checkpoint and reconstructs context.
  Use when asked to "save progress", "checkpoint", "resume", or "where was I".
allowed-tools:
  - Bash
  - Read
  - Write
